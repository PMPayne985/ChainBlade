...
namespace BeautifyEffect {
    ...
    public class BeautifyEffectInspector : Editor {
        ...
        SerializedProperty _quality, _preset, _syncWithProfile, _compareMode, _compareLineAngle, _compareSameSide, _comparePanning, _compareLineWidth, _profile;
        ...
        void OnEnable() {
            ...
            _compareSameSide = serializedObject.FindProperty("_compareSameSide");
        ...
        public override void OnInspectorGUI() {
            ...
            if (_compareMode.boolValue) {
                EditorGUILayout.PropertyField(_compareSameSide, new GUIContent("   Same Side"));
                if (_compareSameSide.boolValue) {
            ...
            bool isLUT2DEnabled = isShaderFeatureEnabled(Beautify.SKW_LUT, false);
            bool isLUT3DEnabled = isShaderFeatureEnabled(Beautify.SKW_LUT3D, false);
